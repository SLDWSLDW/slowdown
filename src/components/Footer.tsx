...
export default function Footer() {
  const { comment, shell, copyright, links } = config.footer
  return (
    <footer className="footer">
      <div className="footer-inner">
        ...
        <div className="footer-links">
          {links.github && (
            <a href={links.github} target="_blank" rel="noopener noreferrer" className="footer-link" title="GitHub">
          ...
          {links.email && (
            <a href={links.email} className="footer-link" title="Email">
